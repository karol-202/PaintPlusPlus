...
{
	private static LegacyImage image; // Is there any way to remove this ugly static variable?

	private Context context;

	public ActivityHistoryHelper(LegacyImage image, Context context)
	{
