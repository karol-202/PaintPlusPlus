...
import pl.karol202.paintplus.color.manipulators.InvertColorManipulator.Params

class InvertColorManipulator(private val renderScript: RenderScript) : ColorManipulator<Params>
{
	class Params(selection: ColorManipulatorSelection?) : ColorManipulator.Params(selection)
	...
	override fun run(input: Bitmap, params: Params): Bitmap
	{
		...
		val script = ScriptC_cm_invert(renderScript)
	...
	private fun ScriptC_cm_invert.attachSelection(selection: ColorManipulatorSelection?)
	{
